...
var characters = [
    ...
    { name: '阿兰', rarity: '4', path: 'destruction', combat: 'lightning', img: 'cal/charactor/img/arlan.png', id: 'arlan'},
...
function filterCharacters() {      
    ...
    filteredCharacters.forEach(function(character) {
        ...
        characterButton.addEventListener('click', function() {
            ...
            var targetUrl = `./cal/cal.html?characterId=${character.id}&characterCombat=${character.combat}`;
